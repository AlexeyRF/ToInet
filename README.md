...
---
 ...
 2. Добавить Opera Proxy
 3. Добавить GeminiFixic (утилиту, которую мне нужно написать из-за отвала Agy, она будет фиксить этот самый отвал)
 4. Переработать меню
 5. Добавить установку и настройку ProxyBridge при первом запуске tun
