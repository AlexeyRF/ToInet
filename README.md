...
Либо вы можете использовать готовую версию, для неё нужен только python и установка модулей install.bat <br>
 ...
 1. Nyamebox \ Proxifier \ Proxybridge mode 
 2. Генерация шума UDP и noisy
 3. Добавление запуска доп. программ при старте
 4. Перенос основного порта на 9853
 5. Добавление смены ip (new curcuit)
 6. Реализация механизма нейтрализации цифровых угроз
